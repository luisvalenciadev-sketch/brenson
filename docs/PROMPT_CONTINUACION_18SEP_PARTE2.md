...
### 5. Verificar el dashboard de pedidos del cliente (sub-pregunta abierta de A2)
...
### 6. Cerrar la brecha de `/upload` sin token (opcional, según prioridad)
...
- No des por desplegado nada sin la verificación posterior (pull + comparación para el tema; una petición real para el worker).
